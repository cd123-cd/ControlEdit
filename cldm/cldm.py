...
#     def __init__(self, control_stage_config, control_key, random_bezier_mask,mask_aim, only_mid_control, *args, **kwargs):
...
#         # random_bezier_mask=einops.rearrange(random_bezier_mask,'b h w c -> b c h w')
...
#         cat_c = torch.index_select(c_cat.clone(), dim=1, index=index)

#         N = min(z.shape[0], N)
#         n_row = min(z.shape[0], n_row)
#         log["reconstruction"] = self.decode_first_stage(z)
#         log["control"] = cat_c * 2.0 - 1.0
